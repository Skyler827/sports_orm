...
def gen_leagues(num=10):
    sports = [
        'Baseball', 'Baseball', 'Baseball', 'Basketball', 'Basketball',
        'Basketball', 'Field Hockey', 'Football', 'Football', 'Football',
        'Ice Hockey', 'Ice Hockey', 'Lacrosse', 'Soccer', 'Soccer']
    ...
    locations = [
        'American', 'Atlantic', 'International', 'National',
        'Pacific', 'Transamerican', 'World'
    ]
...
def gen_teams(num=50):
    likely_places = [
        ...
        "Philadelphia", "Phoenix", "Dallas", "Jacksonville", "San Francisco",
        "Seattle", "Denver", "Detroit", "DC", "Boston", "Baltimore", "Atlanta",
        "Miami", "Oakland", "Minneapolis", "New Orleans", "Cleveland",
        "St. Louis", "Pittsburgh", "Toronto", "Montreal", "Vancouver",
        "Mexico City", 'California', 'Texas', 'Florida', 'New York',
        'Pennsylvania', 'Ohio', 'Georgia', 'Michigan', 'Virginia',
        'Washington', 'Arizona', 'Indiana', 'Colorado', "Ontario", "Quebec"
    ]
    ...
    all_places = [
        ...
        "Fort Worth", "Charlotte", "Seattle", "Denver", "El Paso", "Detroit",
        "DC", "Boston", "Memphis", "Nashville", "Portland", "Oklahoma City",
        "Las Vegas", "Baltimore", "Sacramento", "Kansas City", "Atlanta",
        "Raleigh", "Omaha", "Miami", "Oakland", "Minneapolis", "Tulsa",
        "Wichita", "New Orleans", "Cleveland", "St. Louis", "Pittsburgh",
        "Anchorage", "Cincinnati", "Buffalo", "Toronto", "Montreal",
        "Vancouver", "Ottawa", "Calgary", "Edmonton", "Quebec City",
        "Winnipeg", "Mexico City", "Havana", 'California', 'Texas', 'Florida',
        'New York', 'Illinois', 'Pennsylvania', 'Ohio', 'Georgia',
        'North Carolina', 'Michigan', 'New Jersey', 'Virginia', 'Washington',
        'Arizona', 'Massachusetts', 'Indiana', 'Tennessee', 'Missouri',
        'Maryland', 'Wisconsin', 'Minnesota', 'Colorado', 'South Carolina',
        'Alabama', 'Louisiana', 'Kentucky', 'Oregon', 'Oklahoma',
        'Connecticut', 'Puerto Rico', 'Iowa', 'Utah', 'Mississippi',
        'Arkansas',
        'Kansas', 'Nevada', 'New Mexico', 'Nebraska', 'West Virginia', 'Idaho',
        'Hawaii', 'New Hampshire', 'Maine', 'Rhode Island', 'Montana',
        "Ontario", "Quebec", "British Columbia", "Alberta", "Manitoba",
        "Saskatchewan", "New England", "Golden State"
    ]
    ...
    team_names = [
        ...
        "Tigers", "Royals", "Twins", "Astros", "Angels", "Athletics",
        "Mariners", "Rangers", "Marlins", "Mets", "Phillies", "Nationals",
        "Cubs", "Reds", "Brewers", "Pirates", "Cardinals", "Diamondbacks",
        "Rockies", "Dodgers", "Padres", "Giants", "Bills", "Dolphins",
        "Patriots", "Jets", "Ravens", "Bengals", "Browns", "Steelers",
        "Texans", "Colts", "Jaguars", "Titans", "Broncos", "Raiders",
        "Chargers", "Cowboys", "Eagles", "Bears", "Lions", "Packers",
        "Vikings", "Falcons", "Panthers", "Saints", "Buccaneers", "Rams",
        "49ers", "Seahawks", "Celtics", "Nets", "Knicks", "76ers", "Raptors",
        "Bulls", "Cavaliers", "Pistons", "Pacers", "Bucks", "Hawks", "Hornets",
        "Heat", "Magic", "Wizards", "Mavericks", "Rockets", "Grizzlies",
        "Pelicans", "Spurs", "Nuggets", "Timberwolves", "Thunder",
        "Trail Blazers", "Jazz", "Warriors", "Clippers", "Lakers", "Suns",
        "Kings", "Bruins", "Sabres", "Red Wings", "Canadiens", "Senators",
        "Lightning", "Maple Leafs", "Hurricanes", "Blue Jackets", "Devils",
        "Islanders", "Flyers", "Penguins", "Capitals", "Ducks", "Coyotes",
        "Flames", "Oilers", "Sharks", "Canucks", "Blackhawks", "Avalanche",
        "Stars", "Wild", "Predators", "Blues", "Stampeders", "Roughriders",
        "Rough Riders", "Blue Bombers", "Tiger-Cats", "Alouettes", "Redblacks",
        "Argonauts", "Hustlers", "Claws", "Squires", "Pipers", "Sails",
        "Outlaws", "Wranglers", "Stallions", "Breakers", "Blitz", "Gold",
        "Gamblers", "Express", "Showboats", "Generals", "Invaders", "Maulers",
        "Gunslingers", "Bandits", "Federals", "Renegades", "Black Sox",
        "Spiders", "Wolverines", "Colonels", "Bullets", "Robots", "Nightmare",
        "Americans", "Isotopes", "Gladiators"
    ]
...
def gen_players(num=200):
    first_names = [
        ...
        'Sebastian', 'Owen', 'Caleb', 'Nathan', 'Ryan', 'Jack', 'Hunter',
        'Levi', 'Christian', 'Jaxon', 'Julian', 'Landon', 'Grayson',
        'Jonathan', 'Isaiah', 'Charles', 'Emma', 'Olivia', 'Sophia', 'Ava',
